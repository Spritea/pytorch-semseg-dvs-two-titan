...
Tensor_Path = Path("/home/ali/cws/pytorch-semseg-dvs/test_out/scnn/tensors_sum")
...
np.save("/home/ali/cws/pytorch-semseg-dvs/get_score/scnn/pre.npy",pre)
np.save("/home/ali/cws/pytorch-semseg-dvs/get_score/scnn/rec.npy",rec)
print("time: %f" %tt)
