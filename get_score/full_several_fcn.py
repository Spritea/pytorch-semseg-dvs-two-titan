...
Tensor_Path = Path("/home/ali/cws/pytorch-semseg-dvs/test_out/fcn/tensors_sum")
...
np.save("/home/ali/cws/pytorch-semseg-dvs/get_score/fcn/pre.npy",pre)
np.save("/home/ali/cws/pytorch-semseg-dvs/get_score/fcn/rec.npy",rec)
print("time: %f" %tt)
