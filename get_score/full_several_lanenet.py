...
Tensor_Path = Path("/home/ali/cws/pytorch-semseg-dvs/test_out/lanenet/tensors")
...
np.save("/home/ali/cws/pytorch-semseg-dvs/get_score/lanenet/pre.npy",pre)
np.save("/home/ali/cws/pytorch-semseg-dvs/get_score/lanenet/rec.npy",rec)
print("time: %f" %tt)
